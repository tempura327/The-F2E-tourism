<template>
    <b-container>
      ...
      <b-modal id="detail-modal" :title="modalData.Name" size="lg">
        ...
        <h5 class="h5 grey-blue mb-15">{{modalData.DescriptionDetail}}</h5>
        <h5 class="h5 grey-blue mb-15">{{modalData.Description}}</h5>
        ...
        <template #modal-footer>
          <ul class="d-flex justify-content-between w-100 primary font-weight-3">
            <li>
              ...
              <span>{{modalData.OpenTime === 'Sun 24 hours；Mon 24 hours；Tue 24 hours；Wed 24 hours；Thu 24 hours；Fri 24 hours；Sat 24 hours'? '全天開放' : modalData.OpenTime}}</span>
            </li>
            ...
            <li>
              ...
              <span>{{modalData.TicketInfo}}</span>
            </li>
